...
public class UploadedDocCommand {
    ...
    public UploadedDocCommand(String docId, String firstName, String lastName, String instituteName, String post, LocalDate startDate, LocalDate endDate, String typeDoc, String filePath, String adress, String contractType, String salary, String supervisorName, String workingHours, String month, String year, String details) {
        this.docId = docId;
