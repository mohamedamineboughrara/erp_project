...
public class DocCreatedEvent extends BaseEvent <String> {
    ...
    public DocCreatedEvent(String id, String firstName, String lastName, String instituteName, String post, LocalDate startDate, LocalDate endDate, String typeDoc, DocStatus status, String filePath, String adress, String contractType, String salary, String supervisorName, String workingHours, String month, String year, String details) {
        super(id);
