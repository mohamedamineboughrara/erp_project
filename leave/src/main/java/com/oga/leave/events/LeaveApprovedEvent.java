...
@NoArgsConstructor
public class LeaveApprovedEvent extends BaseEvent<String>{
    ...
    public LeaveApprovedEvent(String id, String collaboraterId, String humanResourcesManagerId, String leaveType, LocalDate startDate, LocalDate endDate, double duration, String reason, double leaveBalance, String notes, LeaveStatus status) {
        super(id);
