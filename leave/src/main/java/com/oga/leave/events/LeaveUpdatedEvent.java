...
public class LeaveUpdatedEvent extends BaseEvent<String>{
    ...
    public LeaveUpdatedEvent(String id, String collaboraterId, String humanResourcesManagerId, String leaveType, LocalDate startDate, LocalDate endDate, double duration, String reason, double leaveBalance, String notes, LeaveStatus status) {
        super(id);
