...
public class LeaveCreatedEvent extends BaseEvent<String>{
    ...
    public LeaveCreatedEvent(String id, String collaboraterId, String humanResourcesManagerId, String leaveType, LocalDate startDate, LocalDate endDate, double duration, String reason, double leaveBalance, String notes, LeaveStatus status) {
        super(id);
