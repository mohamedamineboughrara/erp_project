...
public class CreateLeaveCommand extends BaseCommand<String>{
    ...
    public CreateLeaveCommand(String id, String collaboraterId, String humanResourcesManagerId, String leaveType, LocalDate startDate, LocalDate endDate, double duration, String reason, double leaveBalance, String notes) {
        super(id);
