...
public class TacheCreatedEvent extends BaseEvent<String> {
    ...
    public TacheCreatedEvent(String id, String tacheTitle, String tacheDescription, String collaborator, String responsible, String project, LocalDate startDate, LocalDate endDate, tacheStatus status) {
        super(id);
