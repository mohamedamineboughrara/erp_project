...
public class TacheComplitedEvent extends BaseEvent<String> {
    ...
    public TacheComplitedEvent(String id, String tacheTitle, String tacheDescription, String collaborator, String responsible, String project, LocalDate startDate, LocalDate endDate, tacheStatus status) {
        super(id);
