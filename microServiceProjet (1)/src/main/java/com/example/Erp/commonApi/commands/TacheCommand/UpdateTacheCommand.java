...
public class UpdateTacheCommand extends BaseCommand<String> {
    @Getter
    ...
    public UpdateTacheCommand(String id, String tacheTitle, String tacheDescription, String collaborator,String responsible, String project, LocalDate startDate, LocalDate endDate) {
        super(id);
