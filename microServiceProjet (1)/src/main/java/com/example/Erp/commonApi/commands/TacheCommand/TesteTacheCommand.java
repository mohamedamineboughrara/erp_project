...
public class TesteTacheCommand  {
    ...
    public TesteTacheCommand(String id, String tacheTitle, String tacheDescription, String collaborator,String responsible, String project, LocalDate startDate, LocalDate endDate) {
        this.id=id;
